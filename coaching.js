// ANT COACH coaching.js — 2026-07-20 13:34
// ══ CONFIG ══
...
function goNav(el,id){
  ...
  var m={'sc-home':'bn-home','sc-prog':'bn-prog','sc-alim':'bn-alim','sc-suivi':'bn-suivi','sc-defis':'bn-defis'};
  var bn=m[id];if(bn){var bel=document.getElementById(bn);if(bel)bel.classList.add('on');}
  updateAppUI();
  if(id==='sc-prog')setTimeout(loadUserProg,100);
...
// ══ INIT ══
// Init direct (script en bas du body - DOM déjà prêt)
initSuiviQuotidien();
renderPhotoGrid();
renderMensInputsApp();
renderSuiviGraph();
