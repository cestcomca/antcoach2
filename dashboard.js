...
window.editExo=function(gi,ei){var e=MUSCU[gi].e[ei];var nom=(typeof e==="object")?e.nom:e;var note=(typeof e==="object")?e.note:"";var photo=(typeof e==="object")?e.photo:"";var n=prompt("Nom :",nom);if(!n)return;var nt=prompt("Note :",note)||"";MUSCU[gi].e[ei]={nom:n.trim(),note:nt.trim(),photo:photo};saveMyExosToLS();document.getElementById("pc-inner").innerHTML=dbHTML();toast2("Modifie");};
