...
async function init() {
  ...
  if(params.get('checkout') === 'success'){
    ...
    msg.innerHTML = '<div style="font-family:Bebas Neue,sans-serif;font-size:36px;color:#FFD700;letter-spacing:3px">ABONNEMENT ACTIVÉ !</div>'
      ...
      + '<a href="../challenger/challenger.html" style="background:#8B0000;color:#fff;padding:14px 28px;border-radius:10px;font-size:14px;font-weight:600;text-decoration:none;margin-top:8px">Accéder à mon espace →</a>'
...
async function redirectByRole(user) {
  ...
  const map = {
    ...
    challenger_elite:    '../elite/elite.html',
  }
